...
function updateRegisterView(){
    ...
    <form>
    <input type ="password" placeholder="Input password..." oninput="model.input.registerPage.inputPassword=this.value">
    <input type ="password" placeholder="Confirm password.." oninput="model.input.registerPage.inputPasswordConfirm=this.value">
